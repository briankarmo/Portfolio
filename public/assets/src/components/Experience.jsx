...
const techs = [
  ...
  // Tools & Hosting / Integrations & Payments (30–46)
  { id: 30, src: "/assets/aws.png", title: "AWS", style: "shadow-orange-500" },
  { id: 31, src: "/assets/Azure.png", title: "Azure", style: "shadow-blue-500" },
  { id: 32, src: "/assets/googlecloud.png", title: "Google Cloud", style: "shadow-blue-400" },
  { id: 33, src: "/assets/docker.png", title: "Docker", style: "shadow-blue-400" },
  { id: 34, src: "/assets/cicd.webp", title: "CI/CD", style: "shadow-green-400" },
  { id: 35, src: "/assets/api.png", title: "REST APIs", style: "shadow-red-500" },
  { id: 36, src: "/assets/graphql.png", title: "GraphQL", style: "shadow-pink-500" },
  { id: 37, src: "/assets/Postman.png", title: "Postman", style: "shadow-orange-500" },
  { id: 38, src: "/assets/chatgptapi.png", title: "ChatGPT API", style: "shadow-yellow-500" },
  { id: 39, src: "/assets/openai.png", title: "OpenAI", style: "shadow-white" },
  { id: 40, src: "/assets/firebase.png", title: "Firebase", style: "shadow-yellow-400" },
  { id: 41, src: "/assets/stripe.png", title: "Stripe", style: "shadow-indigo-500" },
  { id: 42, src: "/assets/paypal.webp", title: "PayPal API", style: "shadow-blue-800" },
  { id: 43, src: "/assets/github.webp", title: "GitHub", style: "shadow-purple-800" },
  { id: 44, src: "/assets/agile.png", title: "Agile", style: "shadow-blue-500" },
  { id: 45, src: "/assets/Cypress.webp", title: "Cypress", style: "shadow-green-400" },
  { id: 46, src: "/assets/jest.png", title: "Jest", style: "shadow-red-600" },
];
